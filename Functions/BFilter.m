function [ filtd ] = BFilter( passband,stopband,order,traceInfo,HellaInterp10)
...
for trace = traceInfo.reducedtendegreetraces
    HellaInterp10(trace).B_FilteredD2=filtfilt(FC,HellaInterp10(trace).B_X_Interp);
end
...
for trace = traceInfo.reducedtendegreetraces
    plot(HellaInterp10(trace).Field, -HellaInterp10(trace).B_FilteredD2+HellaInterp10(trace).Temp/5e8)
